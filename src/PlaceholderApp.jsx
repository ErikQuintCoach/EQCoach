...
export function PlaceholderApp() {
  ...
  return (
    <>
      <Navigation />
      <Box minH="100vh" bg={bg} mt={spacingTop} pt={spacingTop}>
        <Container maxW="5xl" pb={0} mb={0} mt={spacingTop}>
          <Heading size={{ base: "lg", md: "xl" }} textAlign={"center"} pb={4}>
          ...
          >
            ...
            >
              ...
              <Heading size="md">Wir strukturieren unsere Angebote um</Heading>
